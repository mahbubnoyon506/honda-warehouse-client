        ...
        <div>
            ...
            <div className='category-wrap row m-5'>
                <div className='category col-md-4'>
                    ...
                    <Link className='text-decoration-none d-block my-2' to='#'><img className='w-50 me-3' src="https://i.ibb.co/k66h3G7/catg1.jpg" alt="" /> Air Filter</Link>
                    <Link className='text-decoration-none d-block my-2' to='#'><img className='w-50 me-3' src="https://i.ibb.co/S3SMSrm/catg6.jpg" alt="" /> Oil Filter</Link>
                    <Link className='text-decoration-none d-block my-2' to='#'><img className='w-50 me-3' src="https://i.ibb.co/M6mnSMD/catg2.jpg" alt="" /> Alternator</Link>
                    <Link className='text-decoration-none d-block my-2' to='#'><img className='w-50 me-3' src="https://i.ibb.co/rcGhJQL/catg4.jpg" alt="" /> Break Pads</Link>
                    <Link className='text-decoration-none d-block my-2' to='#'><img className='w-50 me-3' src="https://i.ibb.co/qYyF4LG/catg7.jpg" alt="" /> Radiators</Link>
                    <Link className='text-decoration-none d-block my-2' to='#'><img className='w-50 me-3' src="https://i.ibb.co/Y7Yjs8d/catg8.jpg" alt="" /> Spark Plugs</Link>
                    <Link className='text-decoration-none d-block my-2' to='#'><img className='w-50 me-3' src="https://i.ibb.co/GVftwHZ/catg5.jpg" alt="" /> Head Lights</Link>
                    <Link className='text-decoration-none d-block my-2' to='#'><img className='w-50 me-3' src="https://i.ibb.co/C1KCWYG/catg3.jpg" alt="" /> Belts</Link>
                </div>
                <div className='col-md-8'>
                    ...
                    <Products></Products>
                    <Link to='/manageitems'><Button>Manage Inventory</Button></Link>
                </div>
                </div>
            </div>
        </div>
